    ...
    <div>
      ...
      <div className="overflow-hidden">
        <div className="bg-orange-500 pt-20 pb-80 px-10 relative">
          ...
          <h1 className="text-center text-white font-bold font-heading text-4xl lg:text-6xl max-w-md lg:max-w-4xl mx-auto pb-32 lg:pb-0">
        ...
        <div className="container px-4 mx-auto">
          ...
          <div className="relative h-16 -mt-48 lg:-mt-20 mb-16">
            ...
            <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 py-3 px-8 rounded-2xl bg-gray-50 border border-gray-200 text-lg lg:text-2xl font-bold font-heading whitespace-nowrap">
              Latest articles
            </div>
          </div>
                ...
                <div className="bg-white border border-gray-100 hover:border-orange-500 transition duration-200 rounded-2xl h-full">
                  <div className="relative" style={{ height: '240px' }}>
                    ...
                    <img
                      ...
                      src="solstice-assets/images/blog/post1.png"
                      alt=""
                    />
                  </div>
              ...
              <a href="#">
                <div className="bg-white border border-gray-100 hover:border-orange-500 transition duration-200 rounded-2xl h-full">
                  <div className="relative" style={{ height: '240px' }}>
                    ...
                    <img
                      className="absolute inset-0 w-full h-full object-cover rounded-t-2xl"
                      src="solstice-assets/images/blog/post2.png"
                      alt=""
                    />
                  </div>
                  <div className="py-8 px-6">
              ...
              <a href="#">
                <div className="bg-white border border-gray-100 hover:border-orange-500 transition duration-200 rounded-2xl h-full">
                  <div className="relative" style={{ height: '240px' }}>
                    ...
                    <img
                      className="absolute inset-0 w-full h-full object-cover rounded-t-2xl"
                      src="solstice-assets/images/blog/post3.png"
                      alt=""
                    />
                  </div>
                  <div className="py-8 px-6">
        ...
        <div className="mt-16">
          <a
            className="inline-block py-3 px-7 text-lg leading-7 bg-white hover:bg-orange-50 font-medium text-orange-500 hover:text-orange-600 border border-orange-500 hover:border-orange-600 rounded-md shadow-sm"
            href="#"
          >
            Show More
          </a>
